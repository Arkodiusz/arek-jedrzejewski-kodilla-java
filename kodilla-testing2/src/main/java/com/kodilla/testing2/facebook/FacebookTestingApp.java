...
public class FacebookTestingApp {
    ...
    public static final String XPATH_BUTTON_NEW_ACCOUNT = "//a[@data-testid='open-registration-form-button']";
    public static final String XPATH_INPUT_NAME =  "//input[@name='firstname']";
    ...
    public static final String XPATH_SELECT_MALE =  "//input[@value='2']";
